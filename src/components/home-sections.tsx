...
export const GOOGLE_REVIEWS: GoogleReview[] = [
  ...
  },
  {
    ...
    color: "bg-[#C2185B]",
    time: "לפני 3 חודשים",
    text: "חשוב לי לשתף את החוויה שלי עם השמאי רפאל. בחור מדהים עם לב של זהב, הבית שלי נפל מהטיל בדימונה ולאורך כל הדרך, קיבלתי עדכונים ועזרה בכל דבר שבה לדרכי. חייבת לפרגן על עבודה מדהימה ותמיכה לאורך כל צעד. מעריכה את העבודה והמסירות נורא! ❤️",
  },
  {
    name: "אבי גלסברג",
    initials: "א",
    color: "bg-[#E67E22]",
    time: "לפני 5 חודשים",
    text: "מר רפאל הציג מקצועיות, עמידה בזמנים ותגובתיות מרשימים ביותר! מר רפאל אינו רק איש מקצוע מעולה אלא גם אדם קשוב ורגיש לאוכלוסיה שנפגעה ממעשה איבה. כל הכבוד וירבו כמוהו!",
  },
  {
    name: "meir hen",
    initials: "M",
    color: "bg-[#00897B]",
    time: "לפני 4 חודשים",
    text: "מבקש לשתף חווייות לקוח! הזמנתי את שירותיו של השמאי רפאל ריבוח למתן חוות דעת בנזקי צנרת/דירה. ברצוני לציין כי העמידה בזמנים, הדייקנות, היחס האישי, והכי חשוב...המקצועיות והחדדות!!! חשוב לי לכתוב ולשתף את החוויייה שלי, בכדי שחוכמת נסיון הממונים יעזור לאחרים. אם הייתי צריך לדרג את השירות שקיבלתי מהשמאי רפאל ריבוח, ברור הוא שהדירוג שלי הוא 10!!!",
  },
  {
    name: "ספיר בוקובזה",
    initials: "ס",
    color: "bg-[#4285F4]",
    time: "לפני חודשיים",
    text: "רפאל הגיע אלינו לדירה בהתראה קצרה ערך בדיקה מקיפה לדירה הסביר הכל לפרטי פרטים הכין לנו דוח תוך 24 שעות ונשאר זמין לשאלות גם לאחר סיום הבדיקה ממליצה בחום",
  },
  {
    name: "Ora Shabekov",
    initials: "O",
    color: "bg-[#7B1FA2]",
    time: "לפני 4 חודשים",
    text: "פניתי למס רכוש . ובהמשך במהירות התקשר אלי שמאי בשם רפאל וטיפל בעיניים נזק ריכוזי. יש לציין שהשירות הייתה מעולה מקצועית אמין עם סבלנות רבה . מומלץ ביותר . תודה רבה",
  },
  {
    name: "יהודית כהן",
    initials: "י",
    color: "bg-[#2E7D32]",
    time: "לפני 5 חודשים",
    text: "רפאל בא כשמאי מטעם רשות המיסים. עשה רושם של איש מקצוע מבין ענין. הגון. אדיב,קשוב. תוך דקות ספורות עלה על הנושאים המצריכים טיפול ופיצויי. שיתף פעולה מתוך רצון לעזור ולפתור בעיות.ענה על שאלות בסבלנות גם לאחר שעזב.במצב בו אנחנו נמצאים טוב לדעת שיש ולמצוא אנשים כמוהו. ממליצה עליו מאוד. כן ירבו.תודה רפאל.",
  },
  {
    name: "מירי קמינר-גולד",
    initials: "מ",
    color: "bg-[#E65100]",
    time: "לפני 5 חודשים",
    text: "רפאל הגיע אלינו לאחר פגיעת טיל. טיפל במסירות בנזקי רכוש. הסביר על תהליכים שעלינו לבצע ונתן המלצות מקצועיות חשובות. ענה בסבלנות על השאלות הרבות. תודה מקרב לב שנדע ימים טובים יותר 🙏",
  },
  {
    name: "שמואל חרזי",
    initials: "ש",
    color: "bg-[#37474F]",
    time: "לפני 4 חודשים",
    text: "השרות, היחס וההבנה של כול העוסקים במלאכה ראויה לשבח בכול הקשור לשרות לאזרח הפשוט . תודה אישית לתומר ורפאל שהתחשבו באיש זקן שלא ידע בכלל שיש לו זכויות מהמדינה . יישר כוח !",
  },
];
