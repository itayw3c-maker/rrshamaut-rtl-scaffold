...
export const Route = createFileRoute("/הסדרי-נגישות")({
  head: () => ({
    meta: [
      ...
      <div dir="rtl">
        ...
        <article className="prose-article mx-auto max-w-3xl px-4 py-12 text-right sm:px-6 lg:px-8">
          ...
          <ul>
            ...
            <li>סימון שפה עברית וכיוון RTL על כל עמודי האתר.</li>
            <li>
            ...
            <li>שדות טפסים עם תוויות מקושרות, סימון שדות חובה והודעות שגיאה נגישות לקוראי מסך.</li>
            <li>יעדי מגע (כפתורים וקישורים) בגודל מינימלי של 44×44 פיקסלים במובייל.</li>
